...
export default function App() {
  ...
  return (
    <div className="relative w-full min-h-screen sm:h-screen bg-white font-sans text-zinc-900 flex flex-col overflow-x-hidden sm:overflow-hidden">
      ...
      <main className="relative z-10 w-full flex-1 pt-16 sm:pt-20 pb-28 sm:pb-24 px-4 sm:px-8 flex flex-col justify-start sm:justify-between sm:overflow-y-auto custom-scrollbar">
        
        {/* Top Desktop Row: Hero Card & Desktop Folders */}
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-6 sm:gap-8 max-w-7xl mx-auto w-full my-auto pb-0">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-8 items-center justify-items-center w-full lg:w-auto my-auto mt-6 mb-4 sm:my-auto">
            <DesktopFolder
              id="about"
              label="О НАС"
              onOpen={openWindow}
